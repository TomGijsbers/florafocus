...
class EditProfileButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ElevatedButton(
      onPressed:
          onPressed, // Voer de callback uit wanneer de knop wordt ingedrukt
      child: Text('Bewerk Profiel',
          style:
              TextStyle(fontFamily: 'Roboto')), // Tekst op de knop met Roboto
      style: ElevatedButton.styleFrom(
        ...
        textStyle: TextStyle(fontSize: 18), // Tekststijl
      ),
    );
  }
}
